...
sudo scutil --set ComputerName "neo"
sudo scutil --set HostName "neo"
sudo scutil --set LocalHostName "neo"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "neo"
